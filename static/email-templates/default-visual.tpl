            ...
            <td>
              ...
              <div style="padding:16px 24px 16px 24px">
                <a href="https://listnun.app"
                  style="color:#FFFFFF;font-size:16px;font-weight:bold;background-color:#1b1e24;border-radius:4px;display:inline-block;padding:12px 20px;text-decoration:none"
                  target="_blank">
